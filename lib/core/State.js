...
var State = Class.extend({
	...
	isFinal: function () {
		//var nestedCallFlowCompleted = !this.nestedCF || this.nestedCF && this.nestedCF._completedFinalState;

		return this._transitions.length == 0 && (!this.nestedCF ||this.nestedCF && (this.nestedCF.getStatus() != 'active'));// && nestedCallFlowCompleted;
	},
